traco = '-'
print(f'Bem-vindo a Loja de Gelados da Pietra Ataulo\n{traco * 20}' + 'Cardápio' + f'{traco * 20}\n{traco * 48}')
# Imprimindo o cardápio
print(f'{traco * 3}| Tamanho  |  Cupuaçu (CP)  |  Açaí (AC) |{traco * 3}')
print(f'{traco * 3}|    P     |    R$  9.00    |  R$ 11.00  |{traco * 3}')
print(f'{traco * 3}|    M     |    R$  14.00   |  R$ 16.00  |{traco * 3}')
print(f'{traco * 3}|    G     |    R$  18.00   |  R$ 20.00  |{traco * 3}\n{traco * 48}')
# Montando o pedido
valor = 0
while True:
